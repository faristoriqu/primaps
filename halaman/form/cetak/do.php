...
<td><?php date_default_timezone_set("Asia/Jakarta"); echo date('d-m-Y'); ?></td>
  ...
  <table cellspacing="30">
    ...
    <?php
      ...
      $query = mysqli_query($koneksi,"SELECT * FROM transaksi_tmp  join barang on transaksi_tmp.id_barang = barang.id_barang JOIN satuan ON barang.ids=satuan.ids WHERE transaksi_tmp.sid='$sid'") or die(mysqli_error());
      $no=1;
      $ttl=0;
