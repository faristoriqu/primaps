                ...
                <tbody>
                   ...
                   date_default_timezone_set("Asia/Jakarta");
                    $tanggal=date('Y-m-d');
                      ...
                      $query = mysqli_query($koneksi,"SELECT * FROM transaksi JOIN detail ON transaksi.kode_transaksi =detail.kode_transaksi JOIN barang ON detail.id_barang=barang.id_barang WHERE tanggal= DATE(NOW()) ORDER BY transaksi.kode_transaksi ASC ") or 
                  $no=1;
